    ...
    var interceptor = function ($q, $window, $scope) {
        return {
            request: function (config) {
                ...
                //    window.location.href = "../Template/MasterPage#/Student";
                //}
                //if (access_token != null && userRole == "Teacher") {
                //    config.headers['Authorization'] = 'Bearer ' + access_token;
                //    window.location.href = "../Template/MasterPage#/Teacher";
                //}
...
app.config(function ($routeProvider) {
    $routeProvider
      .when("/", {
          templateUrl: "../AdminPanel.html", controller: "UserCtrl"
      })      
      .when("/Librarian", {
    ...
    .when("/Author", {
        templateUrl: "../Template/Author.html", controller: "AuthorCtrl"
    })
    .when("/Book", {
        templateUrl: "../Template/Book.html", controller: "BookCtrl"
    })
    .when("/BookIssued", {
        templateUrl: "../Template/BookIssued.html", controller: "BookIssuedCtrl"
    })
    .when("/BookNameWiseReport", {
        templateUrl: "../Template/BookNameWiseReport.html", controller: "BookNameWiseReportCtrl"
    })
    .when("/BookStock", {
        templateUrl: "../Template/BookStock.html", controller: "BookStockCtrl"
    })
    .when("/Category", {
        templateUrl: "../Template/Category.html", controller: "CategoryCtrl"
    })
    .when("/Desk", {
        templateUrl: "../Template/Desk.html", controller: "DeskCtrl"
    })
    .when("/IssuedBookReport", {
        templateUrl: "../Template/IssuedBookReport.html", controller: "IssuedBookReportCtrl"
    })
    .when("/Index", {
        templateUrl: "../Template/Index.html", controller: "BookSearchCtrl"
    })
    .when("/LibraryBildingLevel", {
        templateUrl: "../Template/LibraryBildingLevel.html", controller: "LibraryBuildingLevelCtrl"
    })    
    .when("/Publication", {
        templateUrl: "../Template/Publication.html", controller: "PublicationCtrl"
    })
    .when("/Shelf", {
        templateUrl: "../Template/Shelf.html", controller: "ShelfCtrl"
    })
    .when("/UserIssuedBook", {
        templateUrl: "../Template/UserIssuedBook.html", controller: "UserIssuedBookCtrl"
    })
    .when("/UserReturnedBook", {
        templateUrl: "../Template/UserReturnedBook.html", controller: "UserReturnedBookCtrl"
    })
